    ...
    return (
        <div className="p-6 overflow-x-auto">
            ...
            <div className="overflow-x-auto">
                <table className="table-auto border border-gray-200 text-sm min-w-[4500px]">
                    ...
                    {Array.from({ length: groupEnd - groupStart + 1 }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 border rounded ${page === pageNum ? 'bg-blue-500 text-white' : 'hover:bg-blue-100'}`}
                        >
                          {pageNum}
                        </button>
                      );
